...
const PetInfoModal = ({ pet, onClose }) => {
  ...
  const characteristics = [
    { label: "Friendly with kids", value: pet.kid_friendly || Math.random() > 0.3 },
    { label: "Good with other pets", value: pet.pet_friendly || Math.random() > 0.4 },
    { label: "Needs training", value: pet.needs_training || Math.random() > 0.5 },
    { label: "Energetic", value: pet.energetic || Math.random() > 0.3 },
    { label: "Apartment friendly", value: pet.apartment_friendly || Math.random() > 0.6 },
  ]
              ...
              <div className="md:w-2/5 relative">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                  ...
                  <div className="flex gap-2 mt-3">
                    <span className="bg-white/20 px-3 py-1 rounded-full text-sm">{pet.type}</span>
                    <span className="bg-white/20 px-3 py-1 rounded-full text-sm">{pet.gender}</span>
                  </div>
                </div>
              </div>
