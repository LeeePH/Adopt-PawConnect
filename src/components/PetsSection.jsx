...
const PetsSection = () => {
  ...
  // Handle more info button click for a pet
  ...
  // Filter pets based on search term and pet type filter
  const filteredPets =
  ...
  // Handle matched pets from the matching system
          ...
          <div className="flex gap-3 w-full md:w-auto">
            {isMatchingActive && (
              <motion.button
                ...
                className="flex items-center gap-2 bg-gray-200 text-gray-700 px-4 py-3 rounded-lg hover:bg-gray-300 transition-all duration-200 dark:bg-gray-700 dark:text-gray-200 dark:hover:bg-gray-600"
              ...
              >
                {filteredPets.length > 0 ? (
                  filteredPets.map((pet) => (
                    ...
                    >
                      <PetCards pet={pet} onMoreInfoClick={handleMoreInfoClick} />
                    </motion.div>
                  ))
                ) : (
                  <motion.div
